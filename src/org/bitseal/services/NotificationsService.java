...
public class NotificationsService extends IntentService
{
	...
	{		
		...
		{
			createNewMessagesNotification("1 new message received", "Touch to open Bitseal inbox");
		}
		else
		{
			createNewMessagesNotification(notificationNewMessages + " new messages received", "Touch to open Bitseal inbox");
		}
	 ...
	 */
	private void createNewMessagesNotification(String title, String text)
	{
